...
const GraphComponent = () => {
  ...
  const [elements, setElements] = useState(CytoscapeComponent.normalizeElements(initialData));
  const [selectedNodes, setSelectedNodes] = useState([]);
  const [isSelecting, setIsSelecting] = useState(false);
  const [selectedEdge, setSelectedEdge] = useState(null);
  const [selectedAttribute, setSelectedAttribute] = useState('');
  const [selectedEdgeType, setSelectedEdgeType] = useState('');
  const [selectedEdgeDirection, setSelectedEdgeDirection] = useState('');
  ...
  const [edgeTooltipContent, setEdgeTooltipContent] = useState('');
  ...
  const handleNodeShapeChange = (event) => {
